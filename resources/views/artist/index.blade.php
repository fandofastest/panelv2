                                            ...
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <img alt="Image placeholder" src="{{ asset('storage/artist/'.$item['cover'])}}">
        ...
        <!-- Modal -->
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modaladdgenre">Add New Artist</h5>
